...
banner()
carga()
print(f"{color.azul}CREADOR BY: KING{color.fin}")
print()
  ...
  if valor == "1":
   ...
   if valor == "1":
    ...
    if valor == "1":
     ...
     print(f"{color.verde}EJECUTAR LOS ARHCIVOS QUE TERMINEN EN .py PONDREMOS : {color.amarillo}python, python2, python3 nombre del archivo")
     ...
     if valor == "1":
      ...
      print()
      print(f"{color.morado}SI TENEMOS CLAROS ESTOS COMANDOS PODREMOS EMPEZAR ESPERO QUE LOS AYUDE {color.fin}")
    else:
     exit()
   else:
    exit
